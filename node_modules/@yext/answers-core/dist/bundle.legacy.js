...
function (_super) {
  ...
  function AnswersError(message, code, type) {
    ...
    (0, _setPrototypeOf.default)(_this, AnswersError.prototype);
    return _this;
  }
...
function createFilterSearchResponse(data) {
  ...
  if (response.failedVerticals && response.failedVerticals.length != 0) {
    ...
    throw new _AnswersError.AnswersError(error.details.description, error.details.responseCode, error.errorType);
  }
...
function createUniversalSearchResponse(data) {
  ...
  return {
    ...
    failedVerticals: data.response.failedVerticals && (0, _map.default)(_context2 = data.response.failedVerticals).call(_context2, _createFailedVertical.createFailedVertical)
  };
}
...
"use strict";
module.exports = JSON.parse('{"name":"@yext/answers-core","version":"1.7.0","description":"Typescript Networking Library for the Yext Answers API","main":"./dist/commonjs/src/index.js","module":"./dist/esm/src/index.js","types":"./dist/bundle.d.ts","files":["dist","legacy","lib","src"],"engines":{"node":">=12"},"scripts":{"test":"npm run lint && jest","lint":"eslint .","tsc-cjs":"tsc -p tsconfig.cjs.json","tsc-esm":"tsc -p tsconfig.esm.json","tsc":"npm run tsc-cjs && npm run tsc-esm","build-legacy-bundle":"npx webpack","build":"rm -rf dist/** && npm run tsc && npm run build-legacy-bundle && npm run api-extractor && npm run generate-docs","build-ci":"npm run tsc-cjs && npm run api-extractor && npm run generate-docs","dev":"npm run tsc-esm -- --watch","prepublishOnly":"npm run build","api-extractor":"api-extractor run --local --verbose","generate-docs":"api-documenter markdown --input-folder temp --output-folder docs && rm -rf temp && npm run generate-notices","generate-notices":"generate-license-file --input package.json --output THIRD-PARTY-NOTICES --overwrite"},"repository":{"type":"git","url":"https://github.com/yext/answers-core.git"},"author":"slapshot@yext.com","license":"BSD-3-Clause","bugs":{"url":"https://github.com/yext/answers-core/issues"},"homepage":"https://github.com/yext/answers-core#readme","devDependencies":{"@babel/core":"^7.12.3","@babel/plugin-transform-runtime":"^7.12.10","@babel/preset-env":"^7.12.1","@babel/preset-typescript":"^7.12.1","@microsoft/api-documenter":"^7.13.76","@microsoft/api-extractor":"^7.19.2","@types/jest":"^28.1.1","@typescript-eslint/eslint-plugin":"^5.16.0","@typescript-eslint/parser":"^5.16.0","@yext/eslint-config-slapshot":"^0.2.0","@yext/eslint-plugin-export-star":"^1.0.2","babel-jest":"^26.6.1","babel-loader":"^8.2.2","eslint":"^8.11.0","eslint-config-react-app":"^7.0.0","eslint-plugin-tsdoc":"^0.2.14","generate-license-file":"^1.3.0","jest":"^28.1.0","jest-environment-jsdom":"^28.1.0","ts-loader":"^8.4.0","typescript":"^4.0.3","webpack":"^5.73.0","webpack-cli":"^4.4.0"},"dependencies":{"@babel/runtime-corejs3":"^7.12.5","cross-fetch":"^3.1.5"},"jest":{"bail":0,"collectCoverage":true,"collectCoverageFrom":["src/**","!src/models/**/*.ts"],"verbose":true,"moduleFileExtensions":["js","ts"],"moduleDirectories":["node_modules","<rootDir>"],"testEnvironment":"jsdom","testPathIgnorePatterns":["./tests/mocks/*"],"testMatch":["<rootDir>/tests/**/*.[jt]s"]}}');
